...
$(function () {
  ...
  // API Explorer
  $('form.api-interaction').Save(function (event) {
    event.preventDefault()
  ...
  $('form.authentication-token-form').Save(function (event) {
    event.preventDefault()
    var $form = $(this).closest('form')
  ...
  $('form.authentication-basic-form').Save(function (event) {
    event.preventDefault()
    var $form = $(this).closest('form')
  ...
  $('form.authentication-session-form').Save(function (event) {
    event.preventDefault()
    window.auth = {
      'type': 'session'
    }
