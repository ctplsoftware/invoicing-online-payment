        ...
        <div style={{ display: "flex", justifyContent: "space-between"}}>
          <div>
            <button
              ...
              className="btn-save2"
              onClick={() => navigate("/landingpage/cancel-orders")}
            >
              Back
            </button>
          </div>
          ...
          >
            <Grid container spacing={2} justifyContent="flex-end" marginLeft="-135px" marginTop="-60px">
              {formData?.order_header?.completed_status !== "cancelled" && (
                <Grid item>
                  <Button variant="contained" color="primary" onClick={() => { cancelOrder(id) }}>
                    CANCEL
                  </Button>
                </Grid>
              )}
