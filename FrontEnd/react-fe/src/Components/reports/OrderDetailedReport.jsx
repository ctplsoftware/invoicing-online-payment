...
function OrderDetailedReport() {
  ...
  const route =
    location?.state?.from == "order"
      ? "/landingpage/order-reports"
      : "/landingpage/einvoice-reports";
  ...
  function handleDownload() {
    window.open(`/landingpage/einvoice-print/${order_header_id}?`, "_blank");
    window.focus();
  }
      ...
      <div className="order-imgpreview">
        <div className="orderDetails">
          ...
          <div className="orderDetailsContent">
            ...
            <div className="orderDetailRow">
              <span className="orderDetailKey align-left">
                Delivery Address:
              </span>
              <span className="orderDetailValue">
              ...
              <Typography variant="h6" align="right" sx={{ marginTop: 2 }}>
                {remainingAmount != null && !isNaN(remainingAmount)
                  ? remainingAmount >= 0
                    ...
                    : `Extra Paid Amount: ₹${Math.abs(remainingAmount).toFixed(
                        2
                      )}`
                  : "Invalid Amount"}
              </Typography>
